// The utils folder holds utility functions that are used across the project.

// It should contain general-purpose JavaScript functions and objects, like dropdown options, regex conditions, data formatting functions, etc.
